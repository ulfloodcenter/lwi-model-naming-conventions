...
WS_DATA = [
    ...
    ("TE", "08050003", "Tensas"),
    ("ZN", "08060100", "Lower Mississippi-Natchez"),
    ("ZB", "08070100", "Lower Mississippi-Baton Rouge"),
    ("ST", "08070201", "Bayou Sara-Thompson"),
    ("AM", "08070202", "Amite"),
    ("TI", "08070203", "Tickfaw"),
    ("LM", "08070204", "Lake Maurepas"),
    ("TA", "08070205", "Tangipahoa"),
    ("GR", "08070300", "Lower Grand"),
    ...
    ("ZO", "08090100", "Lower Mississippi-New Orleans"),
